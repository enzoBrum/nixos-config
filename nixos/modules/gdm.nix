          ...
          gnome-shell = superg.gnome-shell.overrideAttrs (old: {
            patches = (old.patches or [ ]) ++ [
              (
                let
                  bg = pkgs.fetchurl {
                    url = "file:///home/erb/repos/nixos-config/assets/wallpaper/blurred_wallhaven-7pm1qy_1920x1080.png";
                    sha256 = "1qs3h4yv22lq0vlmr7ra6iijx1gpzdh8jkizma7wmfk5d1gxzpam";
                  };
                in
